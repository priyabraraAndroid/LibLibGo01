...
public class ApartmentAdapterNew extends BaseAdapter {
    private Context mCtx;
    private List<ApartmentListData> mList;
    private LayoutInflater inflter;

    public ApartmentAdapterNew(Context mCtx, List<ApartmentListData> mList) {
        this.mCtx = mCtx;
        this.mList = mList;
