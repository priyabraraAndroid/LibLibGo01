...
public class NearMeBookAdapterTwo extends RecyclerView.Adapter<NearMeBookAdapterTwo.CategoryHolder> {
    List<BookNewModel.ResModelData.NewBookList> mList;
    Context mCtx;

    public NearMeBookAdapterTwo(List<BookNewModel.ResModelData.NewBookList> mList, Context mCtx) {
        this.mList = mList;
        this.mCtx = mCtx;
    }
