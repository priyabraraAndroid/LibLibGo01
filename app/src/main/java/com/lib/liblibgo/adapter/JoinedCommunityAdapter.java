...
public class JoinedCommunityAdapter extends RecyclerView.Adapter<JoinedCommunityAdapter.LibraryHolder> {
    List<CommunityModel.CommunityResponse.JoinedCommunityResponse> mList;
    Context mCtx;
    CommunityLibraryClickListener listener;

    public JoinedCommunityAdapter(List<CommunityModel.CommunityResponse.JoinedCommunityResponse> mList, Context mCtx) {
        this.mList = mList;
        this.mCtx = mCtx;
    }
