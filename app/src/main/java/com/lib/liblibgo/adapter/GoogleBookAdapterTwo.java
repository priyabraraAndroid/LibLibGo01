...
public class GoogleBookAdapterTwo extends RecyclerView.Adapter<GoogleBookAdapterTwo.CollectHolder> {

    private List<BookDataModel> bookModels = new ArrayList<>();
    private Context ctx;
    private AlertDialog alertDialog;

    public GoogleBookAdapterTwo(List<BookDataModel> bookModels, Context context) {
    ...
    public CollectHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(ctx).inflate(R.layout.google_books_row_two,parent,false);
