...
public class NearMeBookModel {
    ...
    public class ResModelData {
        ...
        @Expose
        public List<NewrmeBookList> book_list = new ArrayList<>();
        ...
        public List<NewrmeBookList> getBook_list() {
            return book_list;
        }

        public void setBook_list(List<NewrmeBookList> book_list) {
            this.book_list = book_list;
        }

        public class NewrmeBookList {
